...
サーボモータ二つを使用して、加速度・ジャイロセンサの動きに対して、2軸で姿勢を水平に戻すことができます．応答速度は遅いです．
...
- ジャンパー線（メス-メス）× 3 ※GY-521のvcc以外のジャンパー線を付け替える．
デモ動画の使用例では、タミヤ/ユニバーサルアームセット1つとM2×25mmねじ，M2ワッシャー，M2ナットを4個ずつ、M3プラねじ，M3プラナットを2個ずつ使用しています．
...
[相補フィルタを使用したスタビライザ（ROS)](https://youtu.be/bdl5ouGuAYI)
